  ...
  return (
    <section className="section-padding bg-[#f8fbff]">
      <div className="mx-auto max-w-6xl">
        ...
        >
          <p className="text-sm font-bold uppercase tracking-widest text-[#0f766e]">Premium control surface</p>
          <h2 className="mt-4 text-4xl font-black leading-tight text-[#07111d] md:text-5xl">
          ...
          {features.map((feature, index) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -6 }}
                className="group rounded-[1.6rem] border border-[#dbe7f1] bg-white p-6 shadow-[0_18px_50px_rgba(15,35,55,0.06)] transition-shadow hover:shadow-[0_28px_80px_rgba(15,35,55,0.11)]"
              >
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-2xl bg-[#e8f7f1] text-[#0f766e] transition-colors group-hover:bg-[#07111d] group-hover:text-white">
                  <Icon className="h-5 w-5" />
                </div>
                <h3 className="text-lg font-black text-[#07111d]">{feature.title}</h3>
                <p className="mt-3 text-sm leading-6 text-[#5b6b7f]">{feature.desc}</p>
              </motion.div>
            );
          })}
        </div>
